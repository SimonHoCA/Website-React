...
import './tfk-news-articles.css'

export default class NewsArticles extends React.Component{
    render(){
        let virtualDOM = (
            <div className={this.props.articleShow?"content-tfk-articles":"content-tfk-articles hidden"}>
                {this.props.articleData}
                <div className='org-link-of-article-tfk'>
                    <hr />
